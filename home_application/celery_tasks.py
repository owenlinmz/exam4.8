...
from home_application.common_esb import fast_execute_script_esb, get_job_instance_log_esb
...
#         'bk_biz_id': bk_biz_id
#     }
#     res = fast_execute_script_esb(client, 'admin', data, base64.b64encode(script_content))
#     time.sleep(5)
#     if res['data']:
#         params = {}
